...
// ─── IDENTITY GATE — rigged "prove you're Papiya" quiz before the voice note ────
// There is NO correct answer. Every option is wrong by design; she can never pass.
// Options are shuffled on every question so it can't be memorised. Unlock is by
// URL flag (?unlock) only — that's the "backend" control.

export const IDENTITY_QUIZ: { question: string; options: string[] }[] = [
  {
    question: "What is my guilty pleasure?",
    options: [
      "I don't need pleasure, I am above all of this",
      "Dating random Italians",
      "I don't have guilt, I am built that way",
      "Janina",
    ],
  },
  {
    question: "Who is my favourite actor?",
    options: ["Me", "Jonathan Bailey", "Janina", "Katrina Kaif <3"],
  },
  {
    question: "In an ideal world, I should be a...",
    options: [
      "A sportsperson",
      "A ballerina",
      "Janina",
      "Where I am — that world is ideal, no need to imagine",
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      "Mutton Kosha & Polao",
      "Biriyani",
      "Anything — I don't understand the difference between good and bad",
      "Janina, depends on my mood",
    ],
  },
  {
    question: "What is my political affiliation?",
    options: [
      "Apolitical, because it doesn't affect me",
      "Right Wing",
      "Left Wing",
      "Neutral — like to go with the trend",
    ],
  },
  {
    question: "What is my mother's name?",
    options: ["Pranati kakima", "Pranati Das", "Maaa", "How dare you ask me this question"],
  },
  {
    question: "Who is the founding member of the Papiya Das fan club?",
    options: [
      "Any guy named Suman",
      "Some senior guy simping on me who claimed to be an elder brother",
      "Janina",
      "IDGAF",
      "Debojyoti Lohua",
    ],
...
// Rotating snark shown on every (always-wrong) answer.
export const QUIZ_WRONG_LINES = [
  "INCORRECT. That's exactly what an impostor would say.",
  "WRONG. Papiya would never.",
  "NOPE. Verification failed. Deeply suspicious.",
  "INCORRECT. Nice try, Shrinjayee Das.",
  "WRONG ANSWER. Recalibrating trust levels...",
  "DENIED. The real Papiya is already annoyed at this question.",
  "INCORRECT. Are you even trying, or is this the chaos?",
  "WRONG. This is going in the file.",
];

export const QUIZ_DENIED = {
  title: "ACCESS DENIED",
  body:
    "Identity could NOT be verified as Papiya. Either you are an impostor — or you are Papiya, and you still got every single one wrong, which is, frankly, the most Papiya outcome possible. The voice note stays locked. Take it up with management.",
};
